...
namespace Da_Vinci_Code_Manager
{
    public partial class frmExposicion : Form
    {
        public frmExposicion()
        {
            ...
            cmbTipoPublico.ContextMenu = new ContextMenu();
            //DON'T TOUCH
        }
...
int nHeightEllipse // width of ellipse
        ...
        private void FrmExposicion_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void CmbTipoPublico_KeyPress(object sender, KeyPressEventArgs e)
        {
            e.Handled = true;
        }
